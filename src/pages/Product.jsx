    ...
    <div className="row m-4">
      ...
      <div className="col p-4">
        ...
        <ul>
          ...
          <li>
            Crystal-Clear 10mm microphone, noise-cancelling, with LED mic-mute
            indicator
          </li>
        ...
        <div className="row container">
          <div className="col">
            ...
            <p>
              ...
              which is known for its comfort, sound quality and durability. With
              plush HyperX signature memory foam in the headband and ear
              ...
              direct access to mute your mic or adjust audio volume. The LED mic
              mute clearly shows when you`re muted. Compatible with PC, PS5,
              Xbox Series X|S, Xbox One, Nintendo Switch, Mac, and Mobile.
              Experience ultimate comfort and sound across your favorite
              platforms.
            </p>
          </div>
          <div className="col gap-0">
            <div className="row">
              ...
              <div className="col-6">
                ...
                <p className="product-desc">DTS® Headphone:X® Spatial Audio</p>
                <p className="product-desc">
